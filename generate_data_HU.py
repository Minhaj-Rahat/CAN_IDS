...
''' Comment out this whole block for data generation

data_file = "DatasetHCRL_gids/DoS_dataset.csv"
...
''' Comment out this whole block for data generation
data_file = "DatasetHCRL_gids/Fuzzy_dataset.csv"
...
f = open('Dataset/Hu/data_fuzzy_29_HU', 'wb')
pickle.dump((x, y), f)
f.close()
# print(ids[0:16])
print(f'Shape of X: {x.shape}')
...
''' Comment out this whole block for data generation
data_file = "DatasetHCRL_gids/gear_dataset.csv"
...
f = open('Dataset/Hu/data_gear_29_HU', 'wb')
pickle.dump((x, y), f)
f.close()
# print(ids[0:16])
print(f'Shape of X: {x.shape}')
...
data_file = "DatasetHCRL_gids/RPM_dataset.csv"
...
f = open('Dataset/Hu/data_rpm_29_HU', 'wb')
pickle.dump((x, y), f)
f.close()
# print(ids[0:16])
print(f'Shape of X: {x.shape}')
